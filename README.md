# @devtea2028/qui-in-optio-voluptate
...
```sh
npm install @devtea2028/qui-in-optio-voluptate
```

## Usage

```js
const tildify = require('@devtea2028/qui-in-optio-voluptate');
...
See [un@devtea2028/qui-in-optio-voluptate](https://github.com/mehmetcanfarsak/un@devtea2028/qui-in-optio-voluptate) for the inverse.
